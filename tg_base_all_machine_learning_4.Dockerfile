...
# nvidia-docker build -t tg/all_machine_learning:4 -f tg_all_machine_learning_cuda8.Dockerfile .
#then build this one
# nvidia-docker build -t tg/base_all_machine_learning:4 -f tg_base_all_machine_learning_3.Dockerfile .


#the goal here - install cv2 , trendi repo , some missing libs

FROM tg/all_machine_learning:4
